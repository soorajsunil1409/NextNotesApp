...
const Navbar = () => {
    ...
    return (
        <div className="p-8 px-10 flex flex-col gap-5">
            <div className="flex text-center justify-between items-center">
                ...
                {status === "authenticated" && (
                    <input
                        type="text"
                        className="p-3 md:block hidden px-6 bg-secondary w-[300px] outline-0 text-primary rounded-3xl"
                        placeholder="Search"
                        value={query}
            ...
            {status === "authenticated" && (
                <input
                    type="text"
                    className="p-3 block md:hidden px-6 bg-secondary w-full outline-0 text-primary rounded-3xl"
                    placeholder="Search"
                    value={query}
                    onChange={(e) => setQuery(e.target.value)}
                />
